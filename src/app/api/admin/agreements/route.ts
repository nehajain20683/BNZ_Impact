...
export async function POST(req: Request) {
  try {
    ...
    const farmer = await prisma.farmer.findFirst({
      ...
      include: { lands: { take: 1 }, organization: true },
    });
    ...
    switch (agreementType) {
      case 'PARTICIPATION_AGREEMENT':
        htmlContent = generateParticipationAgreement({
          ...
          surveyNumber: land?.surveyGutNumber || land?.surveyNumber || undefined, areaAcres: land?.areaAcres || undefined,
          farmerId: farmer.farmerIdGenerated || undefined, org,
        });
        break;
      case 'JOINT_OWNER_NOC':
        htmlContent = generateJointOwnerNOC({
          ...
          surveyNumber: land?.surveyGutNumber || land?.surveyNumber || undefined, village: land?.village || undefined,
      ...
      case 'PAYMENT_RECEIPT':
        htmlContent = generatePaymentReceipt({
          ...
          district: land?.district || undefined, surveyNumber: land?.surveyGutNumber || land?.surveyNumber || undefined,
      ...
      case 'SAPLING_RECEIPT':
        htmlContent = generateSaplingReceipt({
          ...
          village: land?.village || undefined, surveyNumber: land?.surveyGutNumber || land?.surveyNumber || undefined,
          ...
          fieldOfficer: td.fieldOfficer || undefined, org,
        });
        break;
      case 'PLANTATION_CERTIFICATE':
        htmlContent = generatePlantationCertificate({
          ...
          plantationType: td.plantationType || undefined, fieldOfficer: td.fieldOfficer || undefined,
          gpsCoords: land?.gpsLatitude ? `${land.gpsLatitude}, ${land.gpsLongitude}` : undefined,
          projectName: td.projectName || undefined, org,
        });
        break;
      default:
